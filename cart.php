...
<head>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style= "opacity: 0.7; filter:alpha (opacity =70);">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style = "padding-right:100px; "><strong>E-Farm</strong></a>
            </div>
	...
	<div style = "padding: 1em 0 2em 0;">
		...
		<footer id="footer" class="container" style ="bcolor: black; width: 100%; ">
										<hr style = "border-top: 1px solid #ccc;"><br/><br/><br/>
										<p align = "center">Contact Us: +91 1234567890
											&copy; E-Farm. All rights reserved</p>
