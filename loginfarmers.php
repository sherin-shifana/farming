         ...
         <div class="login-form"  style = "margin-top: 75px;">
            <div class = "thumbnail" style="width: 50%; margin:auto;">
               <form method = "POST" style = "width:80%; margin: auto;">
                  ...
                  <h2 align = "center">Farmer's Sign In</h2>
                  ...
                  <a class="link" style = "float: left;padding-left: 20px;"href="registerFarmer.php">Register Here</a><a class="link" style = "float: right; padding-right: 20px;"href="forgot_pass.php">Forgot password?</a></br>
                  </br>
                  <div align = "center">
  ...
  <div class = "thumbnail" style="width: 50%; margin:auto;">
     <form method = "POST" style = "width:80%; margin: auto;">
	    <h1>Farmer's Sign In</h1>
			...
			<a class="link" style = "float: left;padding-left: 20px;"href="registerFarmer.php">Register Here</a><a class="link" style = "float: right; padding-right: 20px;"href="forgot_passfarmer.php">Lost your password?</a></br>
			  </br>
			  <div align = "center">
			 <button style =" width: 45%;" name = "loginBtn" type="submit" class="btn btn-primary" ><strong>SIGN IN</strong></button>
			</br>
